...
\begin{document}
	...
	\begin{itemize}
		...
		\item Estudiar la possible transició de fase sota un procés de percolació de nodes i un d'arestes en el graf de tipus \textit{Hub Graph} o graf Barabási-Albert.
	\end{itemize}
