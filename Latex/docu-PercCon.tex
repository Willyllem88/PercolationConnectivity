...
\begin{document}
	...
	\begin{thebibliography}{99}
		...
		\bibitem{percolation_theory} "Random Geometric Graph", \textit{Wikipedia}. Disponible: \href{https://en.wikipedia.org/wiki/Random\_geometric\_graph}{https://en.wikipedia.org/wiki/Random\_geometric\_graph}. [Accedit: 19-oct-2024].

		\bibitem{percolation_theory} "Barabasi-Albert model", \textit{Wikipedia}. Disponible: \href{https://en.wikipedia.org/wiki/Barab\%C3\%A1si\%E2\%80\%93Albert\_model}{https://en.wikipedia.org/wiki/Barab\%C3\%A1si\%E2\%80\%93Albert\_model}. [Accedit: 19-oct-2024].
